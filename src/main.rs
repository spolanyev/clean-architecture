...
use dictionary::frameworks_and_drivers::interfaces::server_process_center_interface::ServerProcessCenterInterface;
...
use dictionary::frameworks_and_drivers::server::server_process_center::ServerProcessCenter;
...
fn main() {
    ...
    let server_process_center = ServerProcessCenter::new(100, &factory);

    for tcp_stream in listener.incoming() {
        let mut tcp_stream = tcp_stream.expect("Failed to unwrap tcp");

        server_process_center.r#do(Box::new(|| {
